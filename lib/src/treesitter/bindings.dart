...
class TreeSitter {
  ...
  TreeSitter._(
    this._lib, {
    required this._parserNew,
    required this._parserDelete,
    required this._parserSetLanguage,
    required this._parse,
    required this._treeDelete,
    required this._rootNode,
    required this._rootNodeFree,
    required this._nodeType,
    required this._nodeStartByte,
    required this._nodeEndByte,
    required this._nodeChildCount,
    required this._nodeNamedChildCount,
    required this._nodeChild,
    required this._nodeNamedChild,
  });
